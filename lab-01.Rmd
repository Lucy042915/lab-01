...
NA means no integer value given so it can't be added into calculation
...
**Write your answer here**
na.rm is to ask whether you'd like to exclude NA values from the calculation.
...
**Write your answer here**
The data isn't equally distributed (skewed to the right) so that the mean is greater than the median. It indicated that most attractions doesn't bring as much visitors compare to a few that brings a ton.
